...
const source = await readFile(new URL('../dist/workshop-v2.71.js', import.meta.url), 'utf8');
...
assert.ok(entry.includes("new URL('./workshop-v2.71.js', import.meta.url)"), '启动器没有指向 v2.71');
