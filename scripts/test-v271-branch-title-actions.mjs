...
const source = await readFile(new URL('../dist/workshop-v2.95.js', import.meta.url), 'utf8');
...
assert.ok(entry.includes("new URL('./workshop-v2.95.js', import.meta.url)"), '启动器没有指向当前 v2.95');
