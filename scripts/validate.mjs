...
if (workshop.length < 1_000_000 || !workshop.includes('V2.99 已加载')) {
  throw new Error(`v2.99 业务入口不完整：${workshop.length} 字符`);
}

if (!entry.includes('workshop-v3.01.js') || !entry.includes('worldbook-stitch-test3.js') || !entry.includes("const EXTENSION_VERSION = '2.97.14'")) {
