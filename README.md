...
适用于 SillyTavern 的双端预设管理扩展，首个扩展版本由酒馆助手脚本 **v2.53** 无损迁移而来，当前版本为 **v2.82**。
...
- `dist/workshop-v2.82.js`：当前业务入口；从 v2.78 干净基线重建，撤销 v2.79–v2.81 的尝试性开关 workaround，仅保留同作用域旧版开关链路与即时分组刷新。
