...
适用于 SillyTavern 的双端预设管理扩展，首个扩展版本由酒馆助手脚本 **v2.53** 无损迁移而来，当前版本为 **v2.79**。
...
- 跨预设拖入后，下方面板的条目开关会立即刷新，无需再次拖入其他条目触发重绘。

## 目录

- `manifest.json`：SillyTavern 扩展清单。
- `dist/index.js`：标准 SillyTavern 扩展启动器。
- `dist/workshop-v2.79.js`：当前业务入口；保留主题与 iOS 修复，并修复跨预设拖入后下方面板开关延迟显示。
